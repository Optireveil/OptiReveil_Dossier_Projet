...
#define blinking_hour_delay 1500 // time in milliseconds. if PrintHour is set to true,
#define long_press_time 1000 // time in millisecond. We consider that if you press a button longer than long_press_time, your press is a long_press. else, this is a short press
