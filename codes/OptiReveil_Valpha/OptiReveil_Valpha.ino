...
void ambiance_light(){
  ...
  if(ambiant_light_mode == true){
    ...
    if((millis()/vitesse)%1530 < 255){
      light_green = 0;
      light_red = 255;
      light_blue = 255-(millis()/vitesse)%255;
    } else if((millis()/vitesse)%1530 < 510){
      light_green = (millis()/vitesse)%255;
      light_red = 255;
      light_blue = 0;
    } else if((millis()/vitesse)%1530 < 765){
      light_green = 255;
      light_red = 255-(millis()/vitesse)%255;
      light_blue = 0;
    } else if((millis()/vitesse)%1530 < 1020){
      light_green = 255;
      light_red = 0;
      light_blue = (millis()/vitesse)%255;
    } else if((millis()/vitesse)%1530 < 1275){
      light_green = 255-(millis()/vitesse)%255;
      light_red = 0;
      light_blue = 255;
    } else {
      light_green = 0;
      light_red = (millis()/vitesse)%255;
      light_blue = 255;
    }
