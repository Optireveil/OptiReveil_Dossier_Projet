...
#define time_starting_night 17 //time in minute
#define time_record_moves 5 //time in minutes. In mode night, the number of moves will be recorded every [time_record_moves] minutes
